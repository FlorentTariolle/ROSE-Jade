...
(() => {
    ...
    const baseData = [
        {
            ...
            element: [
                ...
                },
                {
                    ...
                    title: "el_Rose_easter_egg",
                    titleName: " ",
                    class: "Rose-easter-egg",
                    id: "RoseEasterEgg",
                },
            ],
        },
    ...
    class RosePlugin {
        ...
        initializeEasterEggSettings() {
            const addSettings = () => {
                const settingsContainer = document.querySelector(".Rose-easter-egg");
            ...
            const observer = new MutationObserver((mutations) => {
                for (const mutation of mutations) {
                    for (const node of mutation.addedNodes) {
                        if (node.classList?.contains("Rose-easter-egg")) {
                            addSettings();
                            return;
                        }
                    }
        ...
        addEasterEggEventListeners() {
            ...
            setTimeout(() => {
                const checkboxes = document.querySelectorAll('.Rose-easter-egg lol-uikit-flat-checkbox');
                if (checkboxes[0]) {
