(() => {
  ...
  const observeProfileOverview = () => {
    ...
    const existingProfileOverview = document.querySelector(
      ".style-profile-overview-content"
    );
  ...
  const createChallengesButton = () => {
    ...
    if (
      existingChallengesGrid &&
      !existingChallengesGrid.querySelector(".easter-egg-button")
    ) {
  ...
  const openPasswordModal = () => {
    ...
    testImg.onload = () => {
      ...
      logoBackground.style.animation =
